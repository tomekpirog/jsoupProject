...
class Websites {
    ...
    private static final String TITLE = URLEncoder.encode("kostka rubika", StandardCharsets.UTF_8);

    private static final String GRY_PLANSZOWE_URL = "https://gryplanszowe.pl/search.php?text=" + TITLE;
    private static final ParsableSiteDTO GRY_PLANSZOWE_DTO = ParsableSiteDTO.builder()
            ...
            .build();
    private static final String ALE_PLANSZOWKI_URL = "https://aleplanszowki.pl/search?controller=search&orderby=quantity&orderway=desc&search_query=" + TITLE + "&submit_search=";
    private static final ParsableSiteDTO ALE_PLANSZOWKI_DTO = ParsableSiteDTO.builder()
            ...
            .build();
    private static final String TROLLE_URL = "https://3trolle.pl/jolisearch?search_query=" + TITLE;
